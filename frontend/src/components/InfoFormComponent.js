      ...
      <form style={{ margin: "5px" }} id="create-event-info-form">
        ...
        <div className="info-form-box">
          ...
          <input
            type={"date"}
            id={"event-date-start"}
            className={"date-time-editevent-input"}
            min={getTodayDate()}
        ...
        {/* address */}
        <div className="info-form-box">
          <label htmlFor="address-input" style={{ display: "block" }}>
            Address :
          </label>
          <textarea
            id="address-input"
            className="text-area"
            rows={2}
            placeholder="Please Enter Address of this Event"
            htmlFor="create-event-info-form"
            value={data.address}
            onChange={(event) => {
              console.log(event.target.value);
        ...
        {/* about */}
        <div className="info-form-box">
          <label htmlFor="about-input" style={{ display: "block" }}>
            About :
          </label>
          <textarea
            id="about-input"
            className="text-area"
            rows={2}
            placeholder="Please Enter More Info about this Event"
            value={data.description}
            form="create-event-info-form"
            onChange={(event) => {
              console.log(event.target.value);
        ...
        <div className="info-form-box">
          <button
            className="custom-button create-event-btn btn btn-success"
